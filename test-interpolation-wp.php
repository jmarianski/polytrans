...
<head>
    ...
    <style>
        ...
        .original { background: #f0f0f0; padding: 10px; margin: 5px 0; }
        .result { background: #e8f5e8; padding: 10px; margin: 5px 0; }
        .error { background: #ffe8e8; padding: 10px; margin: 5px 0; }
